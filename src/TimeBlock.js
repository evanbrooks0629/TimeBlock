...
function TimeBlock(props) {
    ...
    return (
        ...
        >
            ...
            <Grid container sx={{ width: { xs: '66%', sm: '65%', md: '31.5%', lg: '31.5%' }, marginLeft: { xs: '6%', sm: '6%', md: '2.95%', lg: '2.95%' } }} style={{cursor: 'pointer', position: "absolute", height: heightPixels, backgroundColor: props.color, textDecorationColor: "#ffffff"}} onPress={handleClick} onClick={handleClick}>
                ...
                <Grid item xs={2} sm={2} md={2} lg={2} align="right" style={{lineHeight: lineHeightPixels}}>
                    <Button style={{cursor: 'pointer', color: "white", width: "50%", height: "20px"}} onPress={() => handleDelete(props.name)} onClick={() => handleDelete(props.name)}>&#10006;</Button>
                </Grid>
            </Grid>
        </Draggable>
    );
